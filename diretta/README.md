...
| `email-service/prove/diretta-video.prove.js` | il link del video: link HLS `.m3u8` (anche con token), file video, link e codice da incorporare del player della web TV, YouTube; rifiutati con il motivo http, RTMP/RTSP/SRT, DASH, link con credenziali; la copia del servizio è identica a quella del sito | RISULTATO_video |
