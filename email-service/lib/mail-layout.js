...
function avvolgi(inner) {
    return '<!doctype html>\n'
        ...
        + '.rv-corpo p,.rv-corpo div,.rv-corpo li,.rv-corpo blockquote{text-align:justify;-webkit-hyphens:auto;hyphens:auto;}\n'
        ...
        + '<tr><td class="rv-pad rv-corpo" style="padding:24px;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.6;color:#1E293B;text-align:justify;-webkit-hyphens:auto;hyphens:auto;">\n'
        + inner
        + FIRMA
        + '\n</td></tr></table>\n'
        + '</td></tr></table>\n'
