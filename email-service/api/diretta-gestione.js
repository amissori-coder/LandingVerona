/* ============================================================
   ...
   Le azioni (campo `azione`) e dove sta la logica:
     ...
     evento-avviso, anteprima, crea, partecipanti, partecipante,
...
const AZIONI = {
    ...
    'evento-video': async (ctx, b) => ({ evento: await D.cambiaVideo(ctx, { idEvento: b.idEvento, videoUrl: b.videoUrl, videoId: b.videoId }) }),
